...
@Controller
@RequestMapping("/aboutUsWhyIntheboxPage")
public class AboutUsWhyIntheboxController extends AbstractPageController {
    private static final String TEMPLATE_PAGE = "aboutUsWhyIntheboxPage";
