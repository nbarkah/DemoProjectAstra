...
//
//
//public class DefaultCustFacadeGroup2  implements CustomerFacadeGroup2{
//    private static final Logger LOG = Logger.getLogger(de.hybris.platform.commercefacades.customer.impl.DefaultCustomerFacade.class);
//
//    private UserService userService;
//    private CustomerAccServiceGroup2 customerAccountService;
...
//
//    @Override
//    public void register(final RegisterGroup2 registerData) throws DuplicateUidException
//    {
//        validateParameterNotNullStandardMessage("registerData", registerData);
//        Assert.hasText(registerData.getFirstName(), "The field [FirstName] cannot be empty");
//        Assert.hasText(registerData.getLastName(), "The field [LastName] cannot be empty");
//        Assert.hasText(registerData.getLogin(), "The field [Login] cannot be empty");
//        Assert.hasText(registerData.getUserID(), "The field [Login] cannot be empty");
//
//        final CustomerModelGroup2 newCustomer = getModelService().create(CustomerModelGroup2.class);
//        setCommonPropertiesForRegister(registerData, newCustomer);
//        getCustomerAccountService().register(newCustomer, registerData.getPassword());
//    }
//
//    @Override
//    public CustomerData nextDummyCustomerData(final RegisterGroup2 registerData)
//    {
//        final CustomerModelGroup2 userModel = new CustomerModelGroup2();
...
//    }
//
//    protected void setCommonPropertiesForRegister(final RegisterGroup2 registerData, final CustomerModelGroup2 customerModel)
//    {
//        customerModel.setName(getCustomerNameStrategy().getName(registerData.getFirstName(), registerData.getLastName()));
//        customerModel.setUserID(registerData.getUserID());
...
//    }
//
//    protected void setTitleForRegister(final RegisterGroup2 registerData, final CustomerModelGroup2 customerModel)
//    {
...
//        final CustomerModelGroup2 guestCustomer = getModelService().create(CustomerModelGroup2.class);
...
//     */
//    protected void setUidForRegister(final RegisterGroup2 registerData, final CustomerModelGroup2 customer)
//    {
...
//        final CustomerModelGroup2 customer = getCurrentSessionCustomer();
...
//        getEventService().publishEvent(initializeCommerceEvent(new UpdatedProfileEventGroup2(), customer));
//    }
//
//    @Override
...
//            }
//        }
//        getEventService().publishEvent(initializeCommerceEvent(new LoginSuccessGroup2(), getCurrentSessionCustomer()));
//    }
//
//    @Override
//    public void publishLoginSuccessEvent()
//    {
//        CustomerModelGroup2 customer = getCurrentSessionCustomer();
//
...
//        }
//
//        getEventService().publishEvent(initializeCommerceEvent(new LoginSuccessGroup2(), customer));
//    }
//
//    @Override
...
//    }
//
//    protected CustomerModelGroup2 getCurrentSessionCustomer()
//    {
//        return (CustomerModelGroup2) getCurrentUser();
//    }
//
//    @Override
...
//    {
//        final CustomerModelGroup2 currentUser = (CustomerModelGroup2) getUserService().getCurrentUser();
...
//    }
//
//    protected AbstractCommerceGroup2 initializeCommerceEvent(final AbstractCommerceGroup2 event,
//                                                                final CustomerModelGroup2 customerModel)
//    {
...
//    }
//
//    protected CustomerAccServiceGroup2 getCustomerAccountService()
//    {
//        return customerAccountService;
//    }
//
//    @Required
//    public void setCustomerAccountService(final CustomerAccServiceGroup2 customerAccountService)
//    {
