...
@Controller
@RequestMapping("/aboutUsDetailIntheboxPage")
public class AboutUsDetailIntheboxController extends AbstractPageController {
    private static final String TEMPLATE_PAGE = "aboutUsDetailIntheboxPage";
