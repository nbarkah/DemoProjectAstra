...
public class AbstractPageGroup2 extends AbstractController{
    ...
    private static final Logger LOGGER = Logger.getLogger(de.hybris.platform.acceleratorstorefrontcommons.controllers.pages.AbstractPageController.class);
